...
#=> Defines GUI desktop:
export V_GUI="blueman bluez-utils cinnamon engrampa gnome-keyring gnome-screenshot gnome-terminal gvfs gvfs-smb system-config-printer xdg-user-dirs-gtk xed gdm"
